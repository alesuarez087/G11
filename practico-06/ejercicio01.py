...
from pack.datos.DataSocio import DatosSocio
...
class NegocioSocio(object):
    ...
    def regla_2(self, socio):
        ...
        :return: bool
        """
        if (len(socio.nombre)>self.min_caract & len(socio.nombre)<self.max_caract):
            if (len(socio.apellido)>self.min_caract & len(socio.apellido)<self.max_caract):
                return True
            else:
